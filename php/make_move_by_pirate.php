...
try {
    ...
    $stmt = $pdo->prepare('SELECT s335200.make_move_by_pirate(:token, :pirate_id, :target_cell)');
    $stmt->execute(['token' => $token, 'pirate_id' => $pirateId, 'target_cell' => $targetCell]);
